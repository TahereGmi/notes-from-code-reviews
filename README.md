...
<!-- One-line description. Same as your GitHub repo description. -->

This is a growing collection of real lessons from developers who review pull requests every day. It started as a single article — [What Code Reviews Taught Me Over Time](./ARTICLE.md) — and now it's open for everyone to add their own notes.
...
See [CONTRIBUTING.md](./CONTRIBUTING.md) for more details and examples.
...
All content is shared under [Creative Commons Attribution 4.0 (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/). You can share, adapt, and use these notes for any purpose, including commercial — just give credit to the contributors.